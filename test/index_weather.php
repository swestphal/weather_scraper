...
//        document.getElementById("preloader").innerHTML ="<img src='assets/images/316.gif'>";
        xmlhttp.onreadystatechange = function () {
            ...
            return xmlhttp.responseXML.getElementsByTagName("city_selected")[0].innerHTML;
...
//
        ...
        xhttp.open("POST", "assets/languages/weather_translation.xml", true);
...
//console.log(translate("Heavy rain (total 21mm), heaviest during Sat night."));
